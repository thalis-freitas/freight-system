...
describe '#calculate_price' do 
  it 'retorna o preço de uma modalidade de transporte para uma ordem de serviço em centavos' do 
    ...
    PricePerDistance.create!(minimum_distance: 81, maximum_distance: 150, rate: 850, mode_of_transport: mode_of_transport)
    ...
    expect(ModeOfTransportFinder.new(mode_of_transport, service_order).calculate_price). to eq 12350
  end
end
