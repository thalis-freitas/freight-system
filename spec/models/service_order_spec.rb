...
RSpec.describe ServiceOrder, type: :model do
  ...
  describe 'gera um código aleatório' do
    ...
    it 'e o código é único' do
      service_order = ServiceOrder.create!(source_address: 'Rua Paracatu, 957 - São Paulo',
                                           ...
                                           recipient: 'João Cerqueira', recipient_phone: '54988475495',
                                           total_distance: 1120)
      second_service_order = ServiceOrder.new(source_address: 'Travessa Antônio Ferreira, 980 - Capanema',
                                              product_code: 'AANDM-OEHFM-SLDMF', height: 390,
                                              width: 248, depth: 383, weight: 3200,
                                              destination_address: 'Avenida Afonso Pena, 1029 - Belo Horizonte',
  ...
  describe '#==(other)' do
    it 'retorna true se os atributos forem iguais' do
      service_order = ServiceOrder.create!(source_address: 'Rua Paracatu, 957 - São Paulo',
                                           ...
                                           recipient: 'João Cerqueira', recipient_phone: '54988475495',
                                           total_distance: 1120)
      second_service_order = ServiceOrder.create!(source_address: 'Rua Paracatu, 957 - São Paulo',
                                                  product_code: 'AMDNF-EOLDF-SHNFK', height: 70,
                                                  width: 40, depth: 30, weight: 2,
                                                  destination_address: 'Rua da Imprensa, 48 - Gramado',
                                                  recipient: 'João Cerqueira', recipient_phone: '54988475495',
  ...
  describe '#register_price_and_deadline' do
    it 'cadastra o preço e o prazo de uma ordem de serviço de acordo com a modalidade de transporte associada' do
      ...
      Deadline.create!(minimum_distance: 1001, maximum_distance: 2000, estimated_time: 336,
