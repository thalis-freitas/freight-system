  ...
  describe '#valid' do
    ...
    it 'distância máxima deve ser menor ou igual a distância máxima da modalidade de transporte' do
      mode_of_transport = ModeOfTransport.create!(name: 'Econômica', minimum_distance: 500, maximum_distance: 4000,
                                                  ...
                                                  status: :active)
      deadline = Deadline.new(maximum_distance: '4900', mode_of_transport:)
      deadline.valid?
      expect(deadline.errors.include?(:maximum_distance)).to be true
    ...
    it 'distância máxima deve ser maior que a distância mínima da modalidade de transporte' do
      mode_of_transport = ModeOfTransport.create!(name: 'Econômica', minimum_distance: 500, maximum_distance: 4000,
                                                  minimum_weight: 20, maximum_weight: 800, flat_rate: 0,
                                                  status: :active)
      deadline = Deadline.new(maximum_distance: '300', mode_of_transport:)
      deadline.valid?
      expect(deadline.errors.include?(:maximum_distance)).to be true
    ...
    it 'distância mínima deve ser maior ou igual a distância mínima da modalidade de transporte' do
      mode_of_transport = ModeOfTransport.create!(name: 'Econômica', minimum_distance: 500, maximum_distance: 4000,
                                                  minimum_weight: 20, maximum_weight: 800, flat_rate: 0,
                                                  status: :active)
      deadline = Deadline.new(minimum_distance: '200', mode_of_transport:)
      deadline.valid?
      expect(deadline.errors.include?(:minimum_distance)).to be true
    ...
    it 'distância mínima deve ser menor que a distância máxima da modalidade de transporte' do
      mode_of_transport = ModeOfTransport.create!(name: 'Econômica', minimum_distance: 500, maximum_distance: 4000,
                                                  minimum_weight: 20, maximum_weight: 800, flat_rate: 0,
                                                  status: :active)
      deadline = Deadline.new(minimum_distance: '4000', mode_of_transport:)
      deadline.valid?
      expect(deadline.errors.include?(:minimum_distance)).to be true
