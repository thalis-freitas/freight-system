...
describe 'Usuário vê as configurações de preço por peso de uma modalidade de transporte' do
  it 'com sucesso' do
    ...
    PriceByWeight.create!(minimum_weight: 20, maximum_weight: 150, value: 30, mode_of_transport:)
    PriceByWeight.create!(minimum_weight: 151, maximum_weight: 320, value: 50, mode_of_transport:)
    PriceByWeight.create!(minimum_weight: 321, maximum_weight: 500, value: 70, mode_of_transport:)
