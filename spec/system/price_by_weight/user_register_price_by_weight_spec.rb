...
describe 'Usuário cadastra configuração de preço por peso para uma modalidade de transporte' do
  ...
  it 'a partir do menu' do
    ...
    expect(current_path).to eq new_price_by_weight_path
    ...
    within('.form') do 
      ...
      expect(page).to have_field 'Valor por km', type: 'number'
  ...
  it 'com dados incompletos' do
    ...
    expect(page).to_not have_content 'Configuração de preço por peso cadastrada com sucesso para a modalidade Express'
