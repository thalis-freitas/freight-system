...
describe 'Usuário cadastra configuração de preço por distância para uma modalidade de transporte' do
  it 'se estiver autenticado' do
    mode_of_transport = ModeOfTransport.create!(name: 'Express', minimum_distance: 20, maximum_distance: 2000,
                                                ...
                                                status: :active)
    visit new_mode_of_transport_price_per_distance_path(mode_of_transport)
  ...
  it 'a partir do menu' do
    ...
    expect(current_path).to eq new_mode_of_transport_price_per_distance_path(mode_of_transport)
    ...
    within('main form') do
      ...
      expect(page).to have_field 'Taxa (em centavos)', type: 'number'
  ...
  it 'com sucesso' do
    ...
    expect(page).to have_content 'Configuração de preço por distância cadastrada com sucesso'
  ...
  it 'com dados incompletos' do
    ...
    expect(page)
      .not_to have_content 'Configuração de preço por distância cadastrada com sucesso para a modalidade Express'
  ...
  it 'com dados inválidos' do
    ...
    fill_in 'Taxa (em centavos)', with: '-5'
    click_button 'Salvar'
