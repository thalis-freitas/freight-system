...
describe 'Usuário cadastra uma configuração de prazo para uma modalidade de transporte' do
  it 'se estiver autenticado' do 
    ...
    visit new_mode_of_transport_deadline_path(mode_of_transport)
  ...
  it 'a partir do menu' do
    ...
    expect(current_path).to eq new_mode_of_transport_deadline_path(mode_of_transport)
  ...
  it 'com sucesso' do
    ...
    expect(page).to have_content 'Configuração de prazo cadastrada com sucesso'
