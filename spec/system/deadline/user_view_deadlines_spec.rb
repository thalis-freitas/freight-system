...
describe 'Usuário vê as configurações de prazo de uma modalidade de transporte' do
  it 'a partir do menu' do 
    ...
    Deadline.create!(minimum_distance: 500, maximum_distance: 1000, estimated_time: 168, mode_of_transport: mode_of_transport)
    ...
    expect(page).to have_content 'De 500km a 1000km 7 dias'
