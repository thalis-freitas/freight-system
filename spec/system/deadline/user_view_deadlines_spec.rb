...
describe 'Usuário vê as configurações de prazo de uma modalidade de transporte' do
  it 'com sucesso' do
    ...
    Deadline.create!(minimum_distance: 500, maximum_distance: 1000, estimated_time: 120,
                     mode_of_transport:)
    Deadline.create!(minimum_distance: 1001, maximum_distance: 2000, estimated_time: 336,
                     mode_of_transport:)
    Deadline.create!(minimum_distance: 2001, maximum_distance: 3000, estimated_time: 504,
                     mode_of_transport:)
    Deadline.create!(minimum_distance: 3001, maximum_distance: 4000, estimated_time: 672,
                     mode_of_transport:)
