...
describe 'Usuário vê ordens de serviço encerradas' do 
  ...
  it 'com sucesso' do 
    ...
    service_order = ServiceOrder.create!(source_address: 'Avenida Tocantins, 384 - Jataí', product_code: 'SBDNF-PRIFM-SHFMD',
                                         ...
                                         mode_of_transport: economica, vehicle: vehicle, started_in: 1.week.ago, closed_in: 1.day.ago,
                                         status: :closed_on_deadline)
    allow(SecureRandom).to receive(:alphanumeric).with(15).and_return('123456789ABCDEF')
    second_service_order = ServiceOrder.create!(source_address: 'Avenida Rio Branco, 482 - Jataí', product_code: 'SBDNF-PRIFM-SHFMD',
                                                 height: 87, width: 135, depth: 38, weight: 55, destination_address: 'Zona Portuária, 30 - Rio Grande',
                                                 recipient: 'Julia Menezes', recipient_phone: '53933204958', total_distance: 1730,
                                                 mode_of_transport: economica, vehicle: vehicle, started_in: 2.months.ago, closed_in: 1.day.ago,
