...
describe 'Usuário inicia uma ordem serviço pendente' do
  it 'a partir da página inicial' do
    ...
    ServiceOrder.create!(source_address: 'Avenida Tocantins, 384 - Jataí',
    ...
    Deadline.create!(minimum_distance: 1501, maximum_distance: 2000, estimated_time: 144,
                     mode_of_transport: disk_envios)
  ...
  it 'com sucesso' do
    ...
    user = User.create!(name: 'Marcelo Costa', email: 'marcelo@sistemadefrete.com.br', password: 'pass1234')
    Vehicle.create!(nameplate: 'ISX8398', brand: 'Mercedez Benz', model: '710 PLUS',
  ...
  it 'e deve ser alocado o veículo com a menor capacidade máxima que for compatível com a ordem de serviço' do
    ...
    Vehicle.create!(nameplate: 'ISX8398', brand: 'Mercedez Benz', model: '710 PLUS',
                    year_of_manufacture: '2020', maximum_capacity: 6700)
    second_vehicle = Vehicle.create!(nameplate: 'LVN8395', brand: 'Foton', model: 'Minitruck 3.5',
                                     year_of_manufacture: '2020', maximum_capacity: 1450)
