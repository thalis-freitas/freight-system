...
describe 'Usuário vê ordens de serviço em andamento' do
  it 'na página inicial' do
    ...
    service_order = ServiceOrder.create!(source_address: 'Avenida Getúlio Vargas, 250 - Feira de Santana',
                                         ...
                                         mode_of_transport: express, started_in: 16.hours.ago)
    allow(SecureRandom).to receive(:alphanumeric).with(15).and_return('123ABCDEFGHI456')
    second_service_order = ServiceOrder.create!(source_address: 'Rua José Pacheco, 25 - Maranguape',
                                                product_code: 'MDKSJ-RACKH-ASM24', height: 50,
                                                width: 120, depth: 40, weight: 8,
                                                destination_address: 'Rua Beatriz, 57 - Fortaleza',
                                                recipient: 'Joana Matos', recipient_phone: '85999284839',
                                                total_distance: 30, status: :in_progress,
                                                mode_of_transport: express, started_in: 1.day.ago)
