...
Deadline.create!(minimum_distance: 1501, maximum_distance: 3000, estimated_time: 120,
                 mode_of_transport: frota_exclusiva)
Deadline.create!(minimum_distance: 4001, maximum_distance: 6000, estimated_time: 216,
                 mode_of_transport: frota_exclusiva)
...
Deadline.create!(minimum_distance: 501, maximum_distance: 800, estimated_time: 120,
                 mode_of_transport: ramos_transportes)

rota10 = ModeOfTransport.create!(name: 'Rota 10', minimum_distance: 50, maximum_distance: 1200,
                                 minimum_weight: 5000, maximum_weight: 23_000, flat_rate: 500)
PriceByWeight.create!(minimum_weight: 5000, maximum_weight: 8000, value: 15, mode_of_transport: rota10)
PriceByWeight.create!(minimum_weight: 8001, maximum_weight: 14_000, value: 45, mode_of_transport: rota10)
PriceByWeight.create!(minimum_weight: 14_001, maximum_weight: 20_000, value: 80, mode_of_transport: rota10)
PriceByWeight.create!(minimum_weight: 20_001, maximum_weight: 23_000, value: 99, mode_of_transport: rota10)
PricePerDistance.create!(minimum_distance: 50, maximum_distance: 150, rate: 700, mode_of_transport: rota10)
PricePerDistance.create!(minimum_distance: 151, maximum_distance: 400, rate: 1100, mode_of_transport: rota10)
PricePerDistance.create!(minimum_distance: 401, maximum_distance: 800, rate: 1300, mode_of_transport: rota10)
PricePerDistance.create!(minimum_distance: 801, maximum_distance: 1200, rate: 1600, mode_of_transport: rota10)
Deadline.create!(minimum_distance: 50, maximum_distance: 200, estimated_time: 24, mode_of_transport: rota10)
Deadline.create!(minimum_distance: 201, maximum_distance: 600, estimated_time: 72, mode_of_transport: rota10)
Deadline.create!(minimum_distance: 601, maximum_distance: 900, estimated_time: 120, mode_of_transport: rota10)
Deadline.create!(minimum_distance: 901, maximum_distance: 1200, estimated_time: 168, mode_of_transport: rota10)
...
carga_pesada = ModeOfTransport.create!(name: 'Carga Pesada', minimum_distance: 0, maximum_distance: 2000,
                                       minimum_weight: 6000, maximum_weight: 30_000, flat_rate: 950, status: :active)
PriceByWeight.create!(minimum_weight: 6000, maximum_weight: 12_000, value: 130, mode_of_transport: carga_pesada)
PriceByWeight.create!(minimum_weight: 12_001, maximum_weight: 18_000, value: 190, mode_of_transport: carga_pesada)
PriceByWeight.create!(minimum_weight: 18_001, maximum_weight: 24_000, value: 250, mode_of_transport: carga_pesada)
PriceByWeight.create!(minimum_weight: 24_001, maximum_weight: 30_000, value: 310, mode_of_transport: carga_pesada)
...
vehicle2 = Vehicle.create!(nameplate: 'AKL7566', brand: 'Mercedez Benz', model: 'ATEGO 1315',
                           year_of_manufacture: '2014', maximum_capacity: 13_000)
vehicle3 = Vehicle.create!(nameplate: 'KER0414', brand: 'Volks', model: 'Constelallation 17.250',
                           year_of_manufacture: '2012', maximum_capacity: 16_000)
vehicle4 = Vehicle.create!(nameplate: 'ISX8398', brand: 'Mercedez Benz', model: '710 PLUS',
                           year_of_manufacture: '2020', maximum_capacity: 6700)
vehicle5 = Vehicle.create!(nameplate: 'LON3232', brand: 'Fiat', model: 'Doblò Cargo',
                           year_of_manufacture: '2019', maximum_capacity: 3200)
vehicle6 = Vehicle.create!(nameplate: 'JNR6542', brand: 'Peugeot', model: 'Boxer',
                           year_of_manufacture: '2022', maximum_capacity: 1667)
...
Vehicle.create!(nameplate: 'JZZ2991', brand: 'Iveco', model: 'Tector 170 E 25', year_of_manufacture: '2012',
                maximum_capacity: 17_000, status: :in_maintenance)
...
ServiceOrder.create!(source_address: 'Avenida Getúlio Vargas, 250 | Feira de Santana - BA',
                     product_code: 'MDKSJ-CADGM-ASM24', height: 120,
                     width: 65, depth: 70, weight: 12,
                     destination_address: 'Avenida São Rafael, 478 | Salvador - BA',
...
ServiceOrder.create!(source_address: 'Rua José Pacheco, 25 | Maranguape - CE', product_code: 'MDKSJ-RACKH-ASM24',
                     ...
                     destination_address: 'Rua Beatriz, 57 | Fortaleza - CE',
...
ServiceOrder.create!(source_address: 'Rua Antenor Dias, 110 | Jataí - GO', product_code: 'SBDNF-PAANS-SHFMD',
                     height: 87, width: 135, depth: 38, weight: 52,
                     destination_address: 'Avenida A, 65 | Rio Grande - RS',
...
ServiceOrder.create!(source_address: 'QE 11 Área Especial C, 12 | Brasília - DF ', product_code: 'SMDKE-DLSME-WPDOS',
                     height: 300, width: 250, depth: 300, weight: 10_000,
                     destination_address: 'Avenida Governador José Malcher, 327 | Belém - PA',
                     recipient: 'Janete Garcia', recipient_phone: '91993470058', total_distance: 1960)
ServiceOrder.create!(source_address: 'Travessa Antônio Ferreira, 980 | Capanema - PA',
                     product_code: 'AANDM-OEHFM-SLDMF', height: 390,
                     width: 248, depth: 383, weight: 3200,
                     destination_address: 'Avenida Afonso Pena, 1029 | Belo Horizonte - MG',
...
ServiceOrder.create!(source_address: 'Rodovia Raposo Tavares, 384 | Cotia - SP', product_code: 'AKSMD-EEIFK-DLSOD',
                     height: 120, width: 78, depth: 45, weight: 30,
                     destination_address: 'Rua Barão de Vitória, 293 | Diadema - SP',
...
ServiceOrder.create!(source_address: 'Praça da República, 100 | São Paulo - SP', product_code: 'APPER-PWLSO-EEHXT',
                     height: 30, width: 90, depth: 28, weight: 15,
                     destination_address: 'Rua das Fiandeiras, 370 | São Paulo - SP',
                     recipient: 'Fernando Queiroz', recipient_phone: '11990124892', total_distance: 10)

service_order = ServiceOrder.create!(source_address: 'Avenida Tocantins, 384 | Jataí - GO',
...
service_order2 = ServiceOrder.create!(source_address: 'Avenida Esbertalina Barbosa Damiani, 85 | São Mateus - ES',
                                      product_code: 'AMROS-SMDNT-EPSLD', height: 200,
                                      width: 80, depth: 3, weight: 4,
                                      destination_address: 'Rua Coronel Cardoso, 264 | Campos dos Goytacazes - RJ',
                                      recipient: 'Flávia Andrade', recipient_phone: '22996573849',
                                      total_distance: 510, mode_of_transport: via_cargas,
                                      vehicle: vehicle2, started_in: 5.days.ago, status: :in_progress)
service_order2.register_price_and_deadline
vehicle2.on_delivery!

service_order3 = ServiceOrder.create!(source_address: 'Rua Paracatu, 957 | São Paulo - SP',
                                      ...
                                      vehicle: vehicle3, status: :closed_on_deadline)
service_order3.register_price_and_deadline

service_order4 = ServiceOrder.create!(source_address: 'Avenida Abel Cabral, 253 | Parnamirim - RN',
                                      product_code: 'BHTSP-MEPDR-RIELS', height: 100,
                                      width: 280, depth: 40, weight: 20,
                                      destination_address: 'Travessa Jerusalém, 150 | Aracaju - SE',
                                      recipient: 'Márcio Lopes', recipient_phone: '7991748823',
                                      total_distance: 775, started_in: 15.days.ago,
                                      closed_in: 5.days.ago, mode_of_transport: economica,
                                      vehicle: vehicle4, status: :closed_in_arrears)
service_order4.register_price_and_deadline
overdue_reason = OverdueReason.create!(overdue_reason: 'Falhas na comunicação com o motorista',
                                       service_order: service_order4)
service_order4.overdue_reason = overdue_reason

service_order5 = ServiceOrder.create!(source_address: 'Rua Carlos Augusto Cornelsen, 127 | Curitiba - PR',
                                      product_code: 'XMSOD-EIRUE-ALWED', height: 220,
                                      width: 288, depth: 150, weight: 19,
                                      destination_address: 'Rua Pereira Estéfano, 2930 | São Paulo - SP',
                                      recipient: 'Dante Sila', recipient_phone: '11987220588',
                                      total_distance: 405, started_in: 5.hours.ago,
                                      mode_of_transport: transitar, vehicle: vehicle5, status: :in_progress)
service_order5.register_price_and_deadline
vehicle5.on_delivery!

service_order6 = ServiceOrder.create!(source_address: 'Avenida Castelo Branco, 1220 | Blumenau - SC',
                                      product_code: 'AKSMD-EEIFK-DLSOD', height: 120,
                                      width: 78, depth: 45, weight: 30,
                                      destination_address: 'Travessa Santa Rita, 947 | Parnaíba - PI',
                                      recipient: 'Jeniffer Nascimento', recipient_phone: '86990394855',
                                      total_distance: 3553, started_in: 45.days.ago,
                                      mode_of_transport: economica, vehicle: vehicle3, status: :in_progress)
service_order6.register_price_and_deadline
vehicle3.on_delivery!

service_order7 = ServiceOrder.create!(source_address: 'Avenida Almirante Maximiano Fonseca, 99 | Rio Grande - RS',
                                      product_code: 'GMNBE-LLGXP-AAHTR', height: 75,
                                      width: 128, depth: 60, weight: 50,
                                      destination_address: 'Rua Bromélias, 750 | Rio de Janeiro - RJ',
                                      recipient: 'Evelyn Silveira', recipient_phone: '21992213356',
                                      total_distance: 1790, started_in: 10.days.ago,
                                      mode_of_transport: disk_envios, vehicle: vehicle4,
                                      closed_in: 5.days.ago, status: :closed_on_deadline)
service_order7.register_price_and_deadline

service_order8 = ServiceOrder.create!(source_address: 'Rua Frederico Moura, 999 | Franca - SP',
                                      product_code: 'CMSJD-WLDOS-NDJSL', height: 200,
                                      width: 150, depth: 100, weight: 450,
                                      destination_address: 'Rua Arlindo Nogueira, 238 | Teresina - PI',
                                      recipient: 'Pedro Ferreira', recipient_phone: '86994738443',
                                      total_distance: 2300, started_in: 20.days.ago,
                                      mode_of_transport: fretamax, vehicle: vehicle6,
                                      closed_in: 11.days.ago, status: :closed_on_deadline)
service_order8.register_price_and_deadline
