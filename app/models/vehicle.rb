class Vehicle < ApplicationRecord
  validates :nameplate, :brand, :model, :year_of_manufacture, :maximum_capacity, presence: true
  validates :year_of_manufacture, length: { is: 4 }, allow_blank: true
  validates :nameplate, length: { is: 7 }, allow_blank: true
  validates :maximum_capacity, comparison: { greater_than: 0 }, allow_blank: true
